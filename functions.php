...
function wpbb_courses_assets() {
    $theme = wp_get_theme();
    wp_enqueue_style( 'wpbb-courses-meta', get_stylesheet_uri(), array( 'wp-theme-style' ), $theme->get( 'Version' ) );
    ...
    if ( ! empty( $data['src/scss/public.scss']['file'] ) ) {
        wp_enqueue_style( 'wpbb-courses-app', get_stylesheet_directory_uri() . '/dist/' . ltrim( $data['src/scss/public.scss']['file'], '/' ), array( 'wpbb-courses-meta' ), $theme->get( 'Version' ) );
